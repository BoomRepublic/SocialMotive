...
VALUES
    (2, 'sso|aria-evers-lam|' + LOWER(REPLACE('Aria Evers-Lam', ' ', '')), 'aria.evers-lam@socialmotive.local', 'Aria Evers-Lam', '', '+31 6 55530737', 'Aria Evers-Lam', NULL, 1, GETUTC(), GETUTC()),
    (3, 'sso|arno-de-bruijn|' + LOWER(REPLACE('Arno de Bruijn', ' ', '')), 'arno.debruijn@socialmotive.local', 'Arno de Bruijn', '', '+31 6 54776142', 'Arno de Bruijn', 'Hey there! I am using WhatsApp.', 1, GETUTC(), GETUTC()),
    (5, 'sso|herman-waaijenberg|' + LOWER(REPLACE('Herman Waaijenberg', ' ', '')), 'herman.waaijenberg@socialmotive.local', 'Herman Waaijenberg', '', '+31 6 12910932', 'Herman Waaijenberg', 'Hey there! I am using WhatsApp.', 1, GETUTC(), GETUTC()),
    (6, 'sso|hilda-lubben|' + LOWER(REPLACE('Hilda Lubben', ' ', '')), 'hilda.lubben@socialmotive.local', 'Hilda Lubben', '', '+31 6 53612916', 'Hilda Lubben', 'Hey there! I am using WhatsApp.', 1, GETUTC(), GETUTC()),
